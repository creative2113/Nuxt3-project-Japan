...
<template>
  <div class="relative pb-[38px] lg:pb-[30px]">
    <div class="bg-gradient-to-t from-[#F1F1F1] via-[#FFFFFF] to-[#DDDDDD]">
      <div class="overflow-x-hidden px-5">
          ...
          <Swiper :loop="true" :slides-per-view="5" :space-between="0" :modules="[SwiperNavigation]" :navigation="{
            ...
            <SwiperSlide v-for="(instructor, index) in instructors" :key="index" class="">
              <div class="carousel-item">
                <img :src="instructor.image" width="auto" height="420" alt="presentation" role="presentation"
            ...
            <button aria-label="前へ"
              ...
              <img src="/images/arrow-left.svg" width="50" height="50" alt="presentation" role="presentation"
            ...
            <button aria-label="次へ"
              ...
              <img src="/images/arrow-right.svg" width="50" height="50" alt="presentation" role="presentation"
                loading="lazy" class="w-[30px] lg:w-[50px]" decoding="async" />
            </button>
          </Swiper>
        </div>
      ...
      <div v-if="activeInstructor"
        ...
        <div class="bg-white rounded-[10px] shadow-md">
          ...
          <div
            ...
            <p
              class="text-lg font-semibold tracking-wider ml-3 lg:ml-[10px] max-lg:text-white max-lg:relative max-lg:font-normal max-lg:z-10">
              {{ activeInstructor.name }}
            </p>
            <div
              class="text-center ml-3 lg:ml-5 max-lg:relative max-lg:right-32 max-lg:bottom-8 max-lg:flex max-lg:items-center max-lg:gap-2 max-lg:z-10">
            ...
            <div v-if="activeInstructor.rankImageName" class='absolute top-2.5 right-5 max-lg:-top-2 max-lg:-right-2'>
              <img :src="`/images/${activeInstructor.rankImageName}.webp`" alt="ranking" width="80" height="79"
                loading="lazy" />
            </div>
          </div>
          <!-- /同期パネルヘッダー -->
          ...
          <div class="px-[10px] lg:px-5 pt-5 pb-3 lg:py-5 lg:flex flex-row-reverse gap-[15px]">
            <div class="lg:w-1/2 shrink-0 lg:pl-5">
              <h4
                class="text-[#222222] text-[13px] before:inline-block before:w-[3px] before:h-5 before:bg-[#D87E80] flex items-center gap-2.5">
                レッスンスタイル
              </h4>
            ...
            <div class="mt-[25px] lg:mt-0 pt-5 lg:pt-0 border-transparent border-t-[#EEEEEE] border lg:border-none">
              ...
              <div
                ...
                <div class="lg:flex gap-2">
                  <h4
                    class="text-[#222222] text-[13px] before:inline-block before:w-[2px] before:h-5 before:bg-[#D87E80] flex items-center gap-2.5">
                    対応スタジオ
                  </h4>
          ...
          <div v-if="showDetails[0]">
            ...
            <div
              ...
              <div class="lg:flex">
                <div class="w-[340px] shrink-0">
                  <h4
                    class="text-sm font-semibold tracking-widest pl-[10px] border-l-[3px] border-[#D87E80] border-solid">
                    メンバー満足度
            ...
            <div
              class="p-5 before:block before:w-full before:h-[1px] before:mx-auto before:bg-[#eee] before:-translate-y-5">
              <h4 class="text-sm font-semibold tracking-widest pl-[10px] border-l-[3px] border-[#D87E80] border-solid">
                レッスンで心掛けていること
              </h4>
        ...
        <div v-for="(instructor, index) in instructors?.slice(1, 3)" :key="index" class="mt-5">
          <div class="bg-white shadow-md rounded-[10px]">
            ...
            <div
              ...
              <div
                class="text-center ml-0 lg:ml-5 max-lg:relative max-lg:right-32 max-lg:bottom-8 max-lg:flex max-lg:items-center max-lg:gap-2 max-lg:z-10">
              ...
              <div v-if="instructor.rankImageName" class="absolute top-2.5 right-5 max-lg:-top-2 max-lg:-right-2">
                <img :src="`/images/${instructor.rankImageName}.webp`" alt="ranking" width="80" height="79"
                  loading="lazy" />
              </div>
            </div>
            <!-- /同期パネルヘッダー -->
