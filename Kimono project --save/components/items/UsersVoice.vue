...
<template>
  <div class="lg:bg-[#F2CDCE] pt-[19px] pb-10 relative z-10 lg:shadow-md lg:min-h-[500px] lg:mt-[280px] max-lg:pb-4">
    <div class="hidden lg:block lg:w-[880px] lg:absolute lg:-top-[280px] lg:left-1/2 lg:-translate-x-1/2 lg:z-[-1]">
      <picture>
        <source media="(min-width: 1000px)" srcset="/images/present-10-compressed.webp 1x, /images/present-10-compressed.webp 2x"
          type="image/avif" />
    ...
    <div class="mt-0">
      <div id="user-voice-slider" class="max-w-375 lg:max-w-[800px] mx-auto relative">
              ...
              <div v-else-if="voice.sns === 'instagram'"
                ...
                <div class="mt-2.5 px-2.5 flex justify-between">
                  <div class="flex gap-2.5">
                    <div>
                      <img src="/images/hard-line.svg" width="18" height="15" alt="" role="presentation"
                        decoding="async" />
                    </div>
                    <div>
        ...
        <button aria-label="prev" class="swiper-button-prev !w-[50px] !h-[50px] !-left-[50px] -translate-x-full max-lg:!-left-0 max-lg:translate-x-0">
          <img src="/images/arrow-left.svg" width="30" height="30" alt="" role="presentation" loading="lazy" />
        </button>
        <button aria-label="next" class="swiper-button-next !w-[50px] !h-[50px] !-right-[50px] translate-x-full max-lg:!-right-0 max-lg:translate-x-0">
          <img src="/images/arrow-right.svg" width="30" height="30" alt="" role="presentation" loading="lazy" />
        </button>
      </div>
    </div>
    <ContentItemDetail />
