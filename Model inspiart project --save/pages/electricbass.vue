...
<template>
  <LazySectionPageTop banner="/images/electricbass-top-banner.webp" en_title="Electric bass" title="エレキベースコースのご紹介"
    sub_title="ロック？ポップ？<br>ジャズ？ファンク？<br>どんなジャンルも低音で支えます" bg-from="#77BBDD" bg-to="#6688DD" />
  ...
  <!-- Second Section -->
  <div ref="section1">
    <LazyAtomPageSectionTitle :id="1" title="高品質なエレキベースを<br>何と無料でプレゼント！" sub_title="楽器は買わずにもらっちゃおう！" color="#FC88A7" />
  </div>
  <LazySectionBassList v-if="show1" />
  <LazySectionFirstPageLayout v-if="show1">
    <SectionBassFirstPageContent />
  ...
  <SectionPageBeginner v-if="show2" :id="2" />
  ...
  <SectionInstructors v-if="show3" :id="2" />
  ...
  <SectionMakeDebut v-if="show6" title="エレキベースでプロデビューしよう！" banner="/images/make-debut-banner-2.webp" />
  <SectionProDebut v-if="show6" banner="/images/pro-debut-banner-2.webp" />
